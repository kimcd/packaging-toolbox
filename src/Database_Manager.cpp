...
//const string Database_Manager::DATABASE_FILEPATH = "/users/christopherkim/documents/cpp/packaging-toolbox/src/component_database.csv";
...
void Database_Manager::rewrite_database() const
{
    ...
    rename("/Users/christopherkim/Documents/cpp/packaging-toolbox/src/temp.csv",
           "/users/christopherkim/documents/cpp/packaging-toolbox/src/component_database_.csv");
